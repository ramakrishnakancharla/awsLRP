	...
	<div class="st-content-inner">
		<div class="container-fluid">
            ...
            <div class="media messages-container media-clearfix-xs-min media-grid">
                ...
                <div class="messages-list">
                  <div class="panel panel-default">
					...
					@foreach($list as $key=>$values)
                      <li class="list-group-item genericfriends" attrId="{{$values}}">
                        <a class="pointer">
                          <div class="media">
                            <div class="media-left">
              ...
              <div class="media-body">
                <form class="form-horizontal" role="form" action="{{ route('genericfriendsdata') }}" method="post">
				<div class="panel panel-default share">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control share-text"  placeholder="FRIENDS & REALTIVES INFORMATION" />
                  </div>
                </div>
				{{ csrf_field() }}
					<div class="panel panel-default">
