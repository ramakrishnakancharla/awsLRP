              ...
              <div class="media-body">
				...
				<div class="panel panel-default share">
                  <div class="input-group">
					...
					<div class="input-group-btn">
                      <a href="{{ URL::to('finance-insurance-details/' . $show->FID_ID . '/edit') }}" class="btn btn-warning pointer">Edit</a>
					  {{ Form::open(array('url' => 'finance-insurance-details/' . $show->FID_ID, 'class' => 'pull-right')) }}
									...
									<ul class="list-unstyled profile-about margin-none">
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8">{{Carbon\Carbon::parse($show->PolicyStartDate)->format('d/m/Y')}}</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Type of Insurance</span></div>
										  <div class="col-sm-8">@if(count($NameOfDocType) > 0){{$NameOfInsuranceType->Name}} @endif</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Policy Coverage Amount</span></div>
										  <div class="col-sm-8">{{$show->PolicyCoverageAmount}}</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Frequency Of Payment</span></div>
										  <div class="col-sm-8">@if(count($NameOfDocType) > 0){{$NameOfFrequency->Name}} @endif</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8">{{$show->AgentPremaryContactNo}}</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Agent Mail ID </span></div>
										  <div class="col-sm-8">{{$show->AgentMailID}}</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
