	...
	<div class="st-content-inner">
		...
		{{ HTML::ul($errors->all() )}}
            ...
            <div class="media messages-container media-clearfix-xs-min media-grid">
              ...
              <div class="media-body">
                <form class="form-horizontal" role="form" action="{{ URL::to('general-photos') }}" enctype="multipart/form-data" method="post">
									...
									<ul class="list-unstyled profile-about margin-none">
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input  name="PhotoTitle" type="text" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Photo</span></div>
										  <div class="col-sm-8"><input id="Photo" name="Photo" type="file" accept="image/*" class="form-control"></div>
										</div>
									  </li>
									</ul>
								</div>
