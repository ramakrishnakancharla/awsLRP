	...
	<div class="st-content-inner">
		...
		{{ HTML::ul($errors->all() )}}
            ...
            <div class="media messages-container media-clearfix-xs-min media-grid">
              ...
              <div class="media-body">
                <form class="form-horizontal" role="form" action="{{ URL::to('general-photos') }}" method="post">
									...
									<ul class="list-unstyled profile-about margin-none">
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input id="Photo" name="Photo" type="file" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
