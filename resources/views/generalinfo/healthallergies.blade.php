			  ...
			  <form class="form-horizontal" role="form" action="{{ route('financebankdetails') }}" method="post">
                <div class="panel panel-default share">
                  <div class="input-group row">
                    ...
                    <input type="text" class="form-control share-text" placeholder="healthallergies" />
					<div class="input-group-btn">
							...
							<div class="row">
								<div class="col-lg-6">
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Food</span></div>
										  <div class="col-sm-8"><input name="Food" type="time" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Animals</span></div>
										  <div class="col-sm-8"><input name="Animals"  class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
								...
								<div class="col-lg-6">
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Medicine</span></div>
										  <div class="col-sm-8"><input name="Medicine" type="time" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Others</span></div>
										  <div class="col-sm-8"><input name="Others" type="text" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
