              ...
              <div class="media-body">
				...
				<div class="panel panel-default share">
                  <div class="input-group">
					...
					<div class="input-group-btn">
                      <a href="{{ URL::to('general-personaldocuments/' . $show->GD_ID . '/edit') }}" class="btn btn-warning pointer">Edit</a>
					  {{ Form::open(array('url' => 'general-personaldocuments/' . $show->GD_ID, 'class' => 'pull-right')) }}
									...
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8">{{$show->DocCategory}}</div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
									...
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8">{{$show->FileChoose}}</div>
										</div>
									  </li>
									 <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Link To</span></div>
										  <div class="col-sm-8">{{$show->LinkTo}}</div>
										</div>
									  </li>
									</ul>
								</div>
