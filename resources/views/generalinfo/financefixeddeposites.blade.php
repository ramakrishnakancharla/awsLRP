			  ...
			  <form class="form-horizontal" role="form" action="{{ route('financebankdetails') }}" method="post">
                <div class="panel panel-default share">
                  <div class="input-group row">
                    ...
                    <input type="text" class="form-control share-text" placeholder="financefixeddeposites" />
					<div class="input-group-btn">
									...
									<ul class="list-unstyled profile-about margin-none">
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input name="FDStartDate" type="text" class="form-control datepicker"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input name="PeriodOfDeposite "  class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
									...
									<ul class="list-unstyled profile-about margin-none">
									   <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input name="FDMatuirityDate" type="text" class="form-control datepicker"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8">
												<select name="RateOfInterest"  class="form-control">
													<option>Select</option>
													<option value="Hindu">Hindu</option>
												</select>
										  </div>
