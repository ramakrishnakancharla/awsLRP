			  ...
			  <form class="form-horizontal" role="form" action="{{ route('financebankdetails') }}" method="post">
                <div class="panel panel-default share">
                  <div class="input-group row">
                    ...
                    <input type="text" class="form-control share-text" placeholder="healthmedicalinfo" />
					<div class="input-group-btn">
							...
							<div class="row">
									...
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  ...
										  <div class="col-sm-8"><input  name="Height" type="text" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">BMI</span></div>
										  <div class="col-sm-8"><input  name="BMI"  class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Vision L:</span></div>
										  <div class="col-sm-8"><input name="VisionL"  class="form-control"></div>
										</div>
									  </li>
									</ul>
								</div>
								<div class="col-lg-6">
									<ul class="list-unstyled profile-about margin-none">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Weight</span></div>
										  <div class="col-sm-8"><input  name="Weight" type="time" class="form-control"></div>
										</div>
									  </li>
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Blood Group</span></div>
										  <div class="col-sm-8">
									  ...
									  <li class="padding-v-5">
										<div class="row">
										  <div class="col-sm-4"><span class="text-muted">Vision R</span></div>
										  <div class="col-sm-8"><input  name="VisionR" type="text" class="form-control"></div>
										</div>
									  </li>
									</ul>
								</div>
