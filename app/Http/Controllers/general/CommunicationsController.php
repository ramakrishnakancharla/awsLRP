...
class CommunicationsController extends Controller
{
    public function index(){
		...
		return view('generalinfo/communications.index',compact('gendermaster','maritalstatus','childmaster','metadata','relation','list','genericfamily','genericfriends'));
    }
	...
	public function edit($id)
	{
		...
		return view('generalinfo/communications.edit',compact('gendermaster','maritalstatus','childmaster','metadata','relation','list','genericfamily','edit','genericfriends'));
	}
